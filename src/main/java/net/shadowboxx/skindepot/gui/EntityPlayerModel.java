...
import net.shadowboxx.skindepot.DynamicTextureImage;
import net.shadowboxx.skindepot.HDSkinManager;
import net.shadowboxx.skindepot.ImageBufferDownloadHD;
import net.shadowboxx.skindepot.PreviewTexture;
